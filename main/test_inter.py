...
from common_inter.base import TesterInter
from common_inter.base import TesterInter_STB
import torch
...
def main():
    ...
    # tester = TesterInter(args.test_epoch)
    tester = TesterInter_STB(args.test_epoch)
    ...
    with torch.no_grad():
        for itr, (inputs, targets, meta_info) in enumerate(tqdm(tester.batch_generator)):
            ...
            out, _, _ = tester.model(inputs, targets, meta_info, 'test')
            ...
            # preds['input_joint_coord'].append(targets['joint_coord'])
