...
from models_inter.utils.module import BackboneNet, PoseNet
from models_inter.utils.loss import JointHeatmapLoss, HandTypeLoss, RelRootDepthLoss
...
class Model(nn.Module):
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        if mode == 'train':
            ...
            return out, feat_out, joint_heatmap_out
...
def get_model_inter(mode, joint_num):
